...
\begin{abstract}
    In this preliminary work, we present an approach for the augmentation of clustering with natural language explanations.
    ...
    In this work, we propose a method that aids experts in cluster analysis by providing an iterative, human-in-the-loop methodology of generating cluster explanations.
