...
\address[1]{Address}
%\address[1]{Address line 1\linebreak Address line 2}
%\address[2]{Address}
...
For the code accompanying this example see GitHub repository\footnote{See: \url{https://drive.google.com/file/d/19WTaYN3E7zu2oyXJm9xHg-ScbDQqvTAh/view?usp=sharing}}.
...
\begin{figure}[h!]
  ...
  \caption{Word cloud for a cluster of products presented in Fig.~\ref{fig:example_products} (cluster 13) generated with \textit{meta-data}.}
  \label{fig:wordcloud}
\end{figure}
...
The work of Anonymous Anonymous has been additionally supported by \ldots

The work of Anonymous Anonymous was supported by \ldots
\end{acknowledgments}
