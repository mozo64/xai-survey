...
Putting label to group of similar objects is one of the ways how humans describe the world.
It begins with notion that some phenomena or entities differ from each other and that they could be divided into distinct classes.
In the process, the clarification of the differences between groups gets better and better.
