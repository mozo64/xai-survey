...
As for "meta-data" which are textual, there are wrappers built on top of SpaCy\footnote{See: \url{https://spacy.io/}} and NLTK\footnote{See: \url{https://www.nltk.org/}} libraries.
