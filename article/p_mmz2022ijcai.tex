...
Similarly in many other methods that aim at explaining diferences between discovered clusters, the clsutering task is trasformed to classification one, and the classifier is then explained with available XAI methods such as LIME~\cite{lime}, Anchor~\cite{anchor}, LUX~\cite{lux2021iccs}, etc.
One of the most recent implementations of such approach can eb found in in~\cite{xaiclust2021}.
