...
It is depicted on Figure 1~\ref{fig:tsne}.
\begin{figure}[h!]
  \centering
...
The next clue is derived from the silhouette score on a plot in the Figure 2~\ref{fig:silhouette}.
\begin{figure}[h!]
  \centering
...
Visualization with T-SNE is presented, this time with clusters colored different colors, which is depicted on Figure 3~\ref{fig:kmeans}.
\begin{figure}[h!]
  \centering
...
She or he can change it and interactively observe the changes in a Figure 4~\ref{fig:decision_tree}.
Moreover, there are presented example observations on Figure 5~\ref{fig:example_products}, word clouds describing clusters on Figure 6~\ref{fig:wordcloud} and LIME explanation for one instance of meta-data Figure 7~\ref{fig:lime}.
\begin{figure}[h!]
  \centering
